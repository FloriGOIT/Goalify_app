...
export const buttonBlueStyle =
  "flex font-semibold text-white bg-blue-500 w-40 px-3 py-2 border-gray-500 transition duration-300 rounded-lg hover:shadow-[6px_6px_14px_rgba(59,130,246,0.5)]";
